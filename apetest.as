package{
	...
	public class apetest extends Sprite{
		...
		function apetest(){
			...
			APEngine.addMasslessForce(new Vector(0, 0.5));
			...
			var randomX:Number = Math.random()*300+100;
			...
			balls.addParticle(new RigidParticle(randomX, 30, 40,20));
			balls.addParticle(new RigidParticle(randomX+50, 30, 40,20));
			balls.addParticle(new RigidParticle(randomX-50, 30, 40,20,0));
			balls.addParticle(new RigidParticle(randomX+100, 30, 40,20));
			balls.addParticle(new RigidParticle(430, 420, 40,20));
			balls.addParticle(new RigidParticle(430, 400, 40,20));
			balls.addParticle(new RigidParticle(430, 380, 40,20));
			balls.addParticle(new RigidParticle(430, 360, 40,20));
			balls.addParticle(new RigidParticle(430, 340, 40,20));
			balls.addParticle(new RigidParticle(430, 320, 40,20));
			balls.addParticle(new RigidParticle(430, 300, 40,20));
		...
		private function keyDownHandler(keyboardEvent:KeyboardEvent):void {
			if (keyboardEvent.keyCode == 38) {
				...
				balls.addParticle(new RigidParticle(Math.random()*300+100, 30, Math.random()*20+20,Math.random()*20+20,Math.random()*1.6));
